...
pinned to commit SHAs, and Dependabot (`.github/dependabot.yml`) opens one pull request a week at most when any of
them has a new release; merging it is what deploys.
